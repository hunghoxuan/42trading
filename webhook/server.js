...
loadEnvFile();
const SERVER_VERSION = envStr(process.env.WEBHOOK_SERVER_VERSION, "v2026.05.08 21:41 - 9badac1"); // broker sync log writer now matches logs schema; no status/error column inserts
