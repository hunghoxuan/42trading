...
loadEnvFile();
const SERVER_VERSION = envStr(process.env.WEBHOOK_SERVER_VERSION, "v2026.05.14 12:28 - 77211a5b"); // Fix TradePlan chip UX, entry null fallback, and P2 array append behavior
