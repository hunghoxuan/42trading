...
loadEnvFile();
const SERVER_VERSION = envStr(process.env.WEBHOOK_SERVER_VERSION, "v2026.05.21 13:15 - b0761783"); // broker live price stream, tracked-symbols api, timer-split sync+price
