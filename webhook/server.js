...
loadEnvFile();
const SERVER_VERSION = envStr(process.env.WEBHOOK_SERVER_VERSION, "v2026.05.11 07:29 - 0e4a28d"); // AI result cards now use trade-detail style + result route hydration
