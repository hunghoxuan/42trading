...
loadEnvFile();
const SERVER_VERSION = envStr(process.env.WEBHOOK_SERVER_VERSION, "v2026.05.21 15:46 - 0c7b6519"); // broker live price stream, tracked-symbols api, timer-split sync+price
