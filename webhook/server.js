...
loadEnvFile();
const SERVER_VERSION = envStr(process.env.WEBHOOK_SERVER_VERSION, "v2026.05.21 10:30 - 1dc5d07f"); // broker live price stream, tracked-symbols api, timer-split sync+price
