...
loadEnvFile();
const SERVER_VERSION = envStr(process.env.WEBHOOK_SERVER_VERSION, "v2026.05.10 17:19 - 2e73ef8"); // multi-symbol analyze >2: prompt mapping + per-symbol plan coverage + legacy cap removal
