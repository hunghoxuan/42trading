...
loadEnvFile();
const SERVER_VERSION = envStr(process.env.WEBHOOK_SERVER_VERSION, "v2026.05.10 19:07 - e870f6f"); // AI result cards now use trade-detail style + result route hydration
