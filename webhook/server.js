...
loadEnvFile();
const SERVER_VERSION = envStr(process.env.WEBHOOK_SERVER_VERSION, "v2026.05.10 20:22 - 2ffd942"); // AI result cards now use trade-detail style + result route hydration
