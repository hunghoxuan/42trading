...
loadEnvFile();
const SERVER_VERSION = envStr(process.env.WEBHOOK_SERVER_VERSION, "v2026.05.09 08:00 - 2333565"); // broker sync log writer now matches logs schema; no status/error column inserts
