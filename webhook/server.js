...
loadEnvFile();
const SERVER_VERSION = envStr(process.env.WEBHOOK_SERVER_VERSION, "v2026.05.21 12:45 - d46d5a03"); // broker live price stream, tracked-symbols api, timer-split sync+price
