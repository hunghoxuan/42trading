...
loadEnvFile();
const SERVER_VERSION = envStr(process.env.WEBHOOK_SERVER_VERSION, "v2026.05.11 08:13 - 587bc3b"); // AI result cards now use trade-detail style + result route hydration
