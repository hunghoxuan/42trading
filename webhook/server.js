...
loadEnvFile();
const SERVER_VERSION = envStr(process.env.WEBHOOK_SERVER_VERSION, "v2026.05.08 21:28 - 7a5b9c1"); // broker sync log writer now matches logs schema; no status/error column inserts
