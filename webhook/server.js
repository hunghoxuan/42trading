...
loadEnvFile();
const SERVER_VERSION = envStr(process.env.WEBHOOK_SERVER_VERSION, "v2026.05.21 18:04 - 26bf8bf2"); // broker live price stream, tracked-symbols api, timer-split sync+price
