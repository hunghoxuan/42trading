...
loadEnvFile();
const SERVER_VERSION = envStr(process.env.WEBHOOK_SERVER_VERSION, "v2026.05.21 09:55 - 96275cef"); // broker live price stream, tracked-symbols api, timer-split sync+price
