...
loadEnvFile();
const SERVER_VERSION = envStr(process.env.WEBHOOK_SERVER_VERSION, "v2026.05.18 08:35 - 9b7c1d2a"); // precision rule + raw plan preserve + JSON copy action + trades toolbar label cleanup
