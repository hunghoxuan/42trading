...
loadEnvFile();
const SERVER_VERSION = envStr(process.env.WEBHOOK_SERVER_VERSION, "v2026.05.19 20:17 - 605f80b4"); // replace ai_response_schema.json with trade_plan_schema.json, trade_plan at root level
