...
loadEnvFile();
const SERVER_VERSION = envStr(process.env.WEBHOOK_SERVER_VERSION, "v2026.05.20 13:58 - e11c7f3c"); // broker live price stream, tracked-symbols api, timer-split sync+price
