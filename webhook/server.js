...
loadEnvFile();
const SERVER_VERSION = envStr(process.env.WEBHOOK_SERVER_VERSION, "v2026.05.14 11:05 - bb8ea87f"); // Fix TradePlan chip UX, entry null fallback, and P2 array append behavior
