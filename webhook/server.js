...
loadEnvFile();
const SERVER_VERSION = envStr(process.env.WEBHOOK_SERVER_VERSION, "v2026.05.14 20:45 - rr-risk-reward-mapping-fix"); // fix Analyze UI RR mapping to honor risk_reward from JSON
