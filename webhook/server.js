...
loadEnvFile();
const SERVER_VERSION = envStr(process.env.WEBHOOK_SERVER_VERSION, "v2026.05.11 07:26 - 575dcd2"); // AI result cards now use trade-detail style + result route hydration
