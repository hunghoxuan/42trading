...
loadEnvFile();
const SERVER_VERSION = envStr(process.env.WEBHOOK_SERVER_VERSION, "v2026.05.11 06:36 - 14c26bc"); // AI result cards now use trade-detail style + result route hydration
