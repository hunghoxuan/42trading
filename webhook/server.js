...
loadEnvFile();
const SERVER_VERSION = envStr(process.env.WEBHOOK_SERVER_VERSION, "v2026.05.11 09:42 - dd3ddd3"); // AI result cards now use trade-detail style + result route hydration
