...
loadEnvFile();
const SERVER_VERSION = envStr(process.env.WEBHOOK_SERVER_VERSION, "v2026.05.11 11:05 - b1f1a980"); // AI result cards now use trade-detail style + result route hydration
