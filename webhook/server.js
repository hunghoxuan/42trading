...
loadEnvFile();
const SERVER_VERSION = envStr(process.env.WEBHOOK_SERVER_VERSION, "v2026.05.17 08:51 - d9c4e1b9"); // recalc RR from prices, exclude breakeven from TP, and surface TP3 reliably
