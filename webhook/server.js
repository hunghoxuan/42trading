...
loadEnvFile();
const SERVER_VERSION = envStr(process.env.WEBHOOK_SERVER_VERSION, "v2026.05.21 14:26 - 80c8bde3"); // broker live price stream, tracked-symbols api, timer-split sync+price
