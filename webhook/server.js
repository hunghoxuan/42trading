...
loadEnvFile();
const SERVER_VERSION = envStr(process.env.WEBHOOK_SERVER_VERSION, "v2026.05.16 14:44 - 9b77ffe9"); // recalc RR from prices, exclude breakeven from TP, and surface TP3 reliably
