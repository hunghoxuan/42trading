...
loadEnvFile();
const SERVER_VERSION = envStr(process.env.WEBHOOK_SERVER_VERSION, "v2026.05.20 06:57 - b8abad39"); // sync gaps filled: SL_CHANGED/PARTIAL_CLOSE ack, enhanced logging, SSE for non-status changes
