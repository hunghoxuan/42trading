...
loadEnvFile();
const SERVER_VERSION = envStr(process.env.WEBHOOK_SERVER_VERSION, "v2026.05.19 19:52 - 4ee69d85"); // replace ai_response_schema.json with trade_plan_schema.json, trade_plan at root level
