...
loadEnvFile();
const SERVER_VERSION = envStr(process.env.WEBHOOK_SERVER_VERSION, "v2026.05.14 09:36 - 1b8de4fa"); // Unify TradePlan as grouped chart object with show/hide + grouped edit
