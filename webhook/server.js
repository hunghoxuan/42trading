...
loadEnvFile();
const SERVER_VERSION = envStr(process.env.WEBHOOK_SERVER_VERSION, "v2026.05.20 14:01 - 16d53cc4"); // broker live price stream, tracked-symbols api, timer-split sync+price
