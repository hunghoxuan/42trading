...
loadEnvFile();
const SERVER_VERSION = envStr(process.env.WEBHOOK_SERVER_VERSION, "v2026.05.19 18:17 - ee5bbc14"); // replace ai_response_schema.json with trade_plan_schema.json, trade_plan at root level
