...
loadEnvFile();
const SERVER_VERSION = envStr(process.env.WEBHOOK_SERVER_VERSION, "v2026.05.16 15:21 - 0bef75eb"); // recalc RR from prices, exclude breakeven from TP, and surface TP3 reliably
