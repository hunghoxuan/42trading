...
loadEnvFile();
const SERVER_VERSION = envStr(process.env.WEBHOOK_SERVER_VERSION, "v2026.05.10 19:48 - 69ec36c"); // AI result cards now use trade-detail style + result route hydration
