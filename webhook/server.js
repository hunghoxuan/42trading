...
loadEnvFile();
const SERVER_VERSION = envStr(process.env.WEBHOOK_SERVER_VERSION, "v2026.05.10 18:30 - 2f92108"); // AI result cards now use trade-detail style + result route hydration
