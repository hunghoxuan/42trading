...
loadEnvFile();
const SERVER_VERSION = envStr(process.env.WEBHOOK_SERVER_VERSION, "v2026.05.09 06:24 - f5a1705"); // broker sync log writer now matches logs schema; no status/error column inserts
