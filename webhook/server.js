...
loadEnvFile();
const SERVER_VERSION = envStr(process.env.WEBHOOK_SERVER_VERSION, "v2026.05.13 20:59 - 5efedc3d"); // TP resolver prefers first positive value in strict fallback order
