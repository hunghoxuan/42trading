...
loadEnvFile();
const SERVER_VERSION = envStr(process.env.WEBHOOK_SERVER_VERSION, "v2026.05.11 09:48 - 535aeda"); // AI result cards now use trade-detail style + result route hydration
