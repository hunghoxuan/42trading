...
loadEnvFile();
const SERVER_VERSION = envStr(process.env.WEBHOOK_SERVER_VERSION, "v2026.05.20 14:25 - 8c3dd559"); // broker live price stream, tracked-symbols api, timer-split sync+price
