...
loadEnvFile();
const SERVER_VERSION = envStr(process.env.WEBHOOK_SERVER_VERSION, "v2026.05.21 11:13 - 3b562780"); // broker live price stream, tracked-symbols api, timer-split sync+price
