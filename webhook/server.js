...
loadEnvFile();
const SERVER_VERSION = envStr(process.env.WEBHOOK_SERVER_VERSION, "v2026.05.16 14:50 - d34bfbb5"); // recalc RR from prices, exclude breakeven from TP, and surface TP3 reliably
