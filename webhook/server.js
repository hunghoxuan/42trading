...
loadEnvFile();
const SERVER_VERSION = envStr(process.env.WEBHOOK_SERVER_VERSION, "v2026.05.20 14:12 - 0e5a9adc"); // broker live price stream, tracked-symbols api, timer-split sync+price
