...
loadEnvFile();
const SERVER_VERSION = envStr(process.env.WEBHOOK_SERVER_VERSION, "v2026.05.16 07:28 - rr-recalc-ui-tp-fix"); // recalc RR from prices, exclude breakeven from TP, and surface TP3 reliably
