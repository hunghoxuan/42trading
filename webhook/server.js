...
loadEnvFile();
const SERVER_VERSION = envStr(process.env.WEBHOOK_SERVER_VERSION, "v2026.05.09 07:02 - 0bd164e"); // broker sync log writer now matches logs schema; no status/error column inserts
