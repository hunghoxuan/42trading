...
class UnifiedUserObjectStore {
  ...
  mergeUnifiedObject(staticObject, dynamicRow) {
    ...
    if (!merged.object_type && staticObject?.object_type)
      merged.object_type = staticObject.object_type;
    if (!merged.object_id && staticObject?.object_id)
      merged.object_id = staticObject.object_id;
    return merged;
  }
