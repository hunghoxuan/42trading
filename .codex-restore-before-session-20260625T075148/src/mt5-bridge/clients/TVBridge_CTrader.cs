        ...
        private void ExecuteSignal(string json)
        {
            ...
            BeginInvokeOnMainThread(() =>
            {
                    ...
                    if (ticketNum > 0)
                    {
                        ...
                        else
                        {
                            ...
                            else
                            {
                                ...
                                if (totalClosed > 0)
                                    RecordPollEvent(ticketStr, id, symbolCode, action, "CANCELLED_MATCHED_ITEMS", "matched=" + totalClosed.ToString(CultureInfo.InvariantCulture), "closed");
                ...
                if (taskType == "CLOSE")
                {
                    ...
                    if (targets.Count > 0)
                        RecordPollEvent(ticketStr, id, symbolCode, action, "CLOSED_MATCHED_ITEMS", "matched=" + targets.Count.ToString(CultureInfo.InvariantCulture), "closed");
