                    ...
                    {isCacheLikeMode && (
                      ...
                      >
                        <button
                          type="button"
                          className="secondary-button"
                          title="Zoom in: yesterday → today → tomorrow (3 days)"
                          onClick={() =>
                            handleViewportActionAllTimeframes("zoom_3d")
                          }
                          style={{
                            width: 26,
                            height: 22,
                        ...
                        <button
                          type="button"
                          className="secondary-button"
                          title="Zoom out: full week (7 days)"
                          onClick={() =>
                            handleViewportActionAllTimeframes("zoom_week")
                          }
                          style={{
                            width: 26,
                            height: 22,
