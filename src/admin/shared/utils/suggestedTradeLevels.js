import * as clientChartAnalysis from "../../modules/42trade/chartArtifacts/clientChartAnalysis.js";
...
export function buildSuggestedTradeLevels({
  ...
  tfList.forEach((tfRaw) => {
    ...
    tfItems.forEach((item) => {
      const groupKey = clientChartAnalysis.artifactGroupKeyForItem(item);
