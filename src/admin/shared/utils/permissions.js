...
export function pagePermissionForPath(pathname = "") {
  ...
  const prefixes = [
    ...
    ["/studio/", "pages.studio"],
    ["/trades/", "pages.trades"],
    ["/trades0/dashboard/", "pages.dashboard"],
    ["/trades0/analyze/", "pages.ai.analyze"],
    ["/trades0/result/", "pages.ai.analyze"],
    ["/trades0/trade/", "pages.ai.analyze"],
    ["/trades0/manual/", "pages.ai.analyze"],
    ["/trades0/response/", "pages.ai.response"],
    ["/trades0/news/", "pages.ai.news"],
    ["/trades0/backtests/", "pages.backtests"],
    ["/trades0/", "pages.trades"],
