...
export default function SignalDetailCard({
  ...
  const chartClosedAtUnix =
    ...
    response?.exit_time_unix ||
    response?.closed_at_unix ||
    rawData?.exit_time_unix ||
  ...
  const singleTradeReplayTrade = useMemo(() => {
    ...
    return {
      ...
      createdAtSec:
        normalizedTrade.createdAtSec || toEpochSec(chartCreatedAt) || null,
      ...
      <div style={{ display: mainTab === "chart" ? "block" : "none" }}>
        ...
        >
          <SymbolChart
            ...
            openedAt={chartOpenedAt}
            closedAt={chartClosedAt}
            openedAtUnix={chartOpenedAtUnix}
            closedAtUnix={chartClosedAtUnix}
            closeStatus={chartCloseStatus}
            exitPrice={chartExitPrice}
            pnlRealized={chartPnlRealized}
            tradeLabel={chartTradeLabel}
