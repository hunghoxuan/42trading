...
const tradeDetailUtilsSource = readFileSync(
  new URL("../../shared/utils/tradeDetailUtils.jsx", import.meta.url),
  "utf8",
);
const chartSnapshotsSource = readFileSync(
  new URL("../../modules/42trade/pages/ai/ChartSnapshotsPage.jsx", import.meta.url),
  "utf8",
);

test("extractTradePlanFromTrade prefers saved row note and entry model over stale raw plan values", () => {
  assert.match(
    tradeDetailUtilsSource,
