...
var suggestedTradeLevels_exports = {};
__export(suggestedTradeLevels_exports, {
  buildSuggestedTradeLevels: () => buildSuggestedTradeLevels,
  resolveSuggestedTradeTimeframes: () => resolveSuggestedTradeTimeframes
});
module.exports = __toCommonJS(suggestedTradeLevels_exports);
