...
var detectArtifacts_exports = {};
__export(detectArtifacts_exports, {
  artifactReferencePrice: () => artifactReferencePrice,
  artifactReferenceTime: () => artifactReferenceTime,
  buildCandlePatternItems: () => buildCandlePatternItems,
  buildDerivedItemsFromBars: () => buildDerivedItemsFromBars,
  buildFvgZoneItems: () => buildFvgZoneItems,
  buildItemId: () => buildItemId,
  buildLiquidityItems: () => buildLiquidityItems,
  buildOrderBlockItems: () => buildOrderBlockItems,
  buildPreviousDayLevelItems: () => buildPreviousDayLevelItems,
  buildStructureBreakItems: () => buildStructureBreakItems,
  buildSupportDemandLevelItems: () => buildSupportDemandLevelItems,
  buildSweepItems: () => buildSweepItems,
  buildSwingLevelItems: () => buildSwingLevelItems,
  buildZigZagPivotPoints: () => buildZigZagPivotPoints,
  candleBodySize: () => candleBodySize,
  candleRangeSize: () => candleRangeSize,
  dedupeItems: () => dedupeItems,
  findLastOpposingCandle: () => findLastOpposingCandle,
  inferPatternAt: () => inferPatternAt,
  isMeaningfulFvgGap: () => isMeaningfulFvgGap,
  isStrongDisplacementCandle: () => isStrongDisplacementCandle,
  limitArtifactsNearLastBarByType: () => limitArtifactsNearLastBarByType,
  medianNumber: () => medianNumber,
  normalizeBars: () => normalizeBars,
  normalizeChartArtifactItem: () => normalizeChartArtifactItem,
  resolveAdaptiveStructurePivot: () => resolveAdaptiveStructurePivot,
  shouldLimitArtifactType: () => shouldLimitArtifactType,
  utcDayKeyFromUnixSec: () => utcDayKeyFromUnixSec
});
module.exports = __toCommonJS(detectArtifacts_exports);
