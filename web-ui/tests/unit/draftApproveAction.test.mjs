...
const detailSource = readFileSync(
  new URL("../../src/pages/trades/V2TradeDetailPage.jsx", import.meta.url),
  "utf8",
);
const tradesSource = readFileSync(
  new URL("../../src/pages/trades/TradesPage.jsx", import.meta.url),
  "utf8",
);
const signalDetailSource = readFileSync(
  new URL("../../src/components/SignalDetailCard.jsx", import.meta.url),
  "utf8",
);
const editorSource = readFileSync(
  new URL("../../src/components/TradePlanEditor.jsx", import.meta.url),
  "utf8",
);
