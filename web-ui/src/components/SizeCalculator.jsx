...
export function SizeCalculator({ accountId, initialSymbol = "" }) {
  ...
  return (
    <div className="panel fadeIn" style={{ minWidth: 320 }}>
      <div className="panel-label">Size Calculator</div>
      ...
      <div style={{ display: 'flex', flexDirection: 'column', gap: 12 }}>
        ...
        {metrics && (
          <div style={{ display: 'flex', justifyContent: 'space-between', gap: 10, opacity: 0.7, fontSize: 10, borderTop: '1px solid var(--border)', paddingTop: 8 }}>
