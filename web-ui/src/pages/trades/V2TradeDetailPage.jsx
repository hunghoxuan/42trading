        ...
        <Suspense fallback={<div className="loading-card">Loading Details...</div>}>
          <SignalDetailCard
            ...
            metaItems={[
              ...
              { label: "Strategy", value: detailPlan.strategy || trade.strategy || trade.metadata?.strategy || trade.raw_json?.strategy || "-" },
              { label: "Entry Model", value: detailPlan.entry_model || trade.entry_model || trade.metadata?.entry_model || trade.raw_json?.entry_model || "-" },
              ...
              { label: "Skip Recommendation", value: detailPlan.skip_recommendation || "-" },
